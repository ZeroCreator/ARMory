...
- **Kanban** — доски задач внутри проектов и общая доска: колонки, приоритеты, ответственные, дедлайны, вложения, закрытие задач. Поддерживается drag-and-drop и прямые ссылки на задачи.
