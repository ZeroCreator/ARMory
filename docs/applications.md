...
ARMory не содержит специальных настроек, API-прокси или Compose-сервисов для конкретных приложений. Внешние продукты разворачиваются независимо и подключаются одинаковым универсальным способом.
